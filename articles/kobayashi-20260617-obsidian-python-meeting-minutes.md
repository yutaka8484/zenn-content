...
私は愛知県の木工所で経営を支えつつ、個人事業「コバヤシWEBシステム」として製造業のDXにも取り組んでいます。
...
個人事業の強みは、このような**小さな自動化を素早く回せる点**にあります。
...
私は現在、愛知県の木工所を事業承継し、**株式会社コバヤシ**の社長としても活動しています。
...
コバヤシWEBシステムでは、製造業のDX支援・Web制作・サーバー構築・AI活用を一気通貫でサポートしています。
ObsidianやClaude Codeを使った業務効率化に興味がある方は、お気軽にご相談ください。

🌐 コバヤシWEBシステム: ご相談はDMまたはWebサイトから
